# Diagramas del proyecto IECA

Diagramas UML y de arquitectura exportados para el capítulo de diseño de la tesis. Fuente editable del cronograma: `cronograma-ieca.gan` (GanttProject).

---

## Casos de uso (4 módulos, 18 CU)

| Archivo | Contenido |
|---------|-----------|
| [DIAGRAMA CASOS DE USO 1.png](./DIAGRAMA%20CASOS%20DE%20USO%201.png) | Módulo 1 — Seguridad y Acceso |
...
| [DIAGRAMA DE ARQUITECTURA DE LA BASE DE DATOS.png](./DIAGRAMA%20DE%20ARQUITECTURA%20DE%20LA%20BASE%20DE%20DATOS.png) | Colecciones Firestore y relaciones |
